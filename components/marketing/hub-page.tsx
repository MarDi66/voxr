...
export function HubPage({
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12 sm:py-16">
      ...
      <div className="mt-3 h-px bg-linear-to-r from-terracotta/40 via-[#2A2722] to-transparent" />
      ...
      <section className="mt-12 grid gap-5 lg:grid-cols-2">
        {items.map((item) => (
          ...
          >
            <h2 className="font-display text-xl font-medium tracking-tight transition-colors group-hover:text-terracotta">
              {item.label}
            </h2>
